package com.hyssop.algorithm.leetcode.questions.stack;
...
public class LeetcodeStack {
   ...
   //     testToPass2();
    ...
    static class MinStack extends java.util.Stack<java.lang.Integer> {
        ...
        public synchronized java.lang.Integer pop() {
            book.pop();
