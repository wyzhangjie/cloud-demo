package com.hyssop.algorithm.concurrent;
 ...
 * @Author:         zhjie.zhang
 * @CreateDate:     2019/7/29$ 13:42$
 * @UpdateUser:     zhjie.zhang
 * @UpdateDate:     2019/7/29$ 13:42$
 * @Version:        1.0
 */
public class TransmittableThreadLocalService {
    ...
    private static TransmittableThreadLocal<Integer> requestIdThreadLocal1 = new TransmittableThreadLocal<>();
    ...
    static class BusinessTask implements Runnable {
        ...
        public BusinessTask(String parentThreadName) {
            requestIdThreadLocal1.set( requestIdThreadLocal.get());
        ...
        public void run() {
            ...
            System.out.println("parentThreadName:" + parentThreadName + ":" + requestIdThreadLocal.get() + "本地变量："+requestIdThreadLocal1.get());
        }
    }
